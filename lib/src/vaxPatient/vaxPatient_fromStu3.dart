...
VaxPatient _$VaxPatientFromStu3Bundles(
  ...
  var patient = fhir_stu3.Patient.fromJson(patientBundle.entry[0].resource.toJson());
  var recommendation = fhir_stu3.ImmunizationRecommendation.fromJson(recommendationBundle.entry[0].resource.toJson());
  var newPatient = VaxPatient(
    ...
    sex: patient.gender.toString() == 'other'
        ...
        : patient.gender.toString()[0].toUpperCase() +
            patient.gender.toString().substring(
                1, patient.gender.toString().length),
    liveVirusList: <Dose>[],
    pastImmunizations: <Dose>[],
    conditions: <String>[],
    assessmentDate: VaxDate.fromString(recommendation.recommendation[0].date
        .toString()),
    recommendations: VaxRecommendations(
        ...
        recommendedDate: VaxDate.fromString(
          recommendation.recommendation[0].dateCriterion[1].value
              .toString(),
        ),
        pastDueDate: VaxDate.fromString(
          recommendation.recommendation[0].dateCriterion[2].value
              .toString(),
        )),
    seriesGroup:
        recommendation.recommendation[0].protocol.series,
  );
