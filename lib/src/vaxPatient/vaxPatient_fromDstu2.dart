...
VaxPatient _$VaxPatientFromDstu2Bundles(
  ...
  var patient = fhir_dstu2.Patient.fromJson(patientBundle.entry[0].resource.toJson());
  var recommendation = fhir_dstu2.ImmunizationRecommendation.fromJson(recommendationBundle.entry[0].resource.toJson());
  var newPatient = VaxPatient(
    dob: VaxDate.fromString(patient.birthDate.toString()),
